    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="#">Liste des Réservations</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="list_menus.php">Liste des Menus</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="list_types_boissons.php">Liste des Types de Boissons</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="list_plats.php">Liste des Plats</a>
                </li>
                <li class="nav-item">
